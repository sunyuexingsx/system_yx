 ...
 * @date：2016/09/15
 */
public class EndworkVo implements Serializable {
    /**
	 * 
	 */
    ...
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss",timezone="GMT+8")
    private Date  EndworkEndtime;//作业结束时间
    
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss",timezone="GMT+8")
    private Date EndworkBegintime;//作业开始时间
	...
	public void setEndworkBegintime(Date endworkBegintime) {
		EndworkBegintime = endworkBegintime;
	}
