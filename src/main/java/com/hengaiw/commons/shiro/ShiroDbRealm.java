...
import com.hengaiw.service.RoleService;
...
public class ShiroDbRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) throws AuthenticationException {
        ...
        LOGGER.info("登录用户："+user.getLoginname());
        ShiroUser shiroUser = new ShiroUser(user.getId(), user.getLoginname(), user.getName(),user.getUsertype(), roleList);
        // 认证缓存信息
