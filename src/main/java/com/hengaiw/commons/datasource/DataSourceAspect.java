package com.hengaiw.commons.datasource;

import com.hengaiw.commons.annotation.DataSourceChange;
import com.hengaiw.commons.exception.DataSourceAspectException;
...
/**
 * 有{@link com.hengaiw.commons.annotation.DataSourceChange}注解的方法，调用时会切换到指定的数据源
 *
 * @author tanghd
 */
@Aspect
