package com.hengaiw.commons.utils;
...
public class HaPageInfo {
    ...
    //构造方法
    public HaPageInfo(int nowpage, int pagesize) {
        //计算当前页  
        if (nowpage < 0) {
            this.nowpage = 1;
        } else {
    ...
    // 构造方法
    public HaPageInfo(int nowpage, int pagesize, String sort, String order) {
        // 计算当前页  
        if (nowpage < 0) {
            this.nowpage = 1;
        } else {
